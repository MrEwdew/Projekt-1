...
class PredictDummySource(DataSource):
    ...
    def __init__(self, path:str = '../data'):
        ...
        DataSource.__init__(self, 'Predict Data Source')
    ...
    def setup(self):
        ...
        # read file names from specified directory
        #dir_list = os.path.dirname(self.path)
        dir_list = os.path.basename(self.path)
        print(dir_list)
        # filter measurement files
        self.data_files = list(os.path.basename(self.path))
        #= list(filter(lambda fname: fname.endswith('.csv'), dir_list))
        #print(list(filter(lambda fname: fname.endswith('.csv'), dir_list)))
        print(f'-> Log Files: {self.data_files}')
