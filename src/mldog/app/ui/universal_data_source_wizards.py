...
from ..model.universal_data_sources import DummyDataSource, LogDataSource, UDPDataSource, PredictDummySource
...
class PredictDummy(Wizard):
    def __init__(self):
        super().__init__('PredictDummy', 'New PredictDummy')
    ...
    def constructWizardPane(self) -> tk.Frame:
        ...
        # panel container
        # config_pane = ttk.Frame(self.wizard)
        config_pane = ttk.LabelFrame(self.wizard, text = "Datei: ")
        config_pane.columnconfigure(0, weight=0)
        config_pane.columnconfigure(1, weight=1)
        config_pane.columnconfigure(2, weight=0)
        config_pane.rowconfigure(0, weight=0)
    ...
    def selectDirectory(self):
        dir = fd.askopenfilename(initialdir=self.path.get())
    ...
    def finish(self):
        ...
        self.core.setDataSource(PredictDummySource(self.path.get()))