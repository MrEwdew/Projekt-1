...
class StatusBar(tk.Frame):
    ...
    def __init__(self, master):
        ...
        # Activity indicator
        self.active_label = tk.Label(self, text='\u25CF', bd=1, relief=tk.FLAT, anchor=tk.W)
        self.active_label.configure(foreground = 'red')
        self.active_label.grid(column=0, row=0, padx=2, pady=2)

        # Data Source Label
        self.ds_label = tk.Label(self, text='Disconnected', bd=1, relief=tk.FLAT, anchor=tk.W)
